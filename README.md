...
# If branch is omitted, 'production' will be used by default
CUSTOM_APPS=YourUsername/your_app:production,YourUsername/another_app:main
...
- Multiple apps: `CUSTOM_APPS=myorg/app1:production,myorg/app2:main,myorg/app3:version-14`
- Using default branch: `CUSTOM_APPS=myorg/app1,myorg/app2:main` (app1 will use 'production')

**Important Notes:**
- 📋 **Order matters**: Apps are installed in the order listed
- 🔗 **Dependencies**: If app B depends on app A, list app A first
- 🌿 **Default branch**: If no branch is specified, `production` is used
